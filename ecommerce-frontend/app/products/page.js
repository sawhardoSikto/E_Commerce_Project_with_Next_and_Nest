...
export default function ProductsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-100 sticky top-11 z-30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-1.5 flex items-center gap-2">

          {/* Search */}
          <form onSubmit={handleSearch} className="flex gap-1.5 w-56 shrink-0">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-8 pr-3 py-1 text-xs bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-indigo-400 focus:ring-2 focus:ring-indigo-100 focus:bg-white transition-all placeholder:text-gray-400"
              />
              {search && (
          ...
          {/* Category Pills */}
          <div className="flex items-center gap-1.5 overflow-x-auto flex-1 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            <button
            ...
            {categories.map((cat) => (
              <button
                ...
                className={`shrink-0 flex items-center gap-1 px-2.5 py-1 rounded-lg text-[11px] font-medium transition-all border ${
                  category === cat
                    ? 'bg-indigo-600 text-white border-indigo-600'
                    : 'text-gray-600 border-gray-200 hover:bg-gray-50 hover:border-gray-300'
                }`}
