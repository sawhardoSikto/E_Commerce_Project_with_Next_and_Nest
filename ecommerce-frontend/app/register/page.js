      ...
      <div className="w-full max-w-xs">
        ...
        <div className="text-center mb-5">
          <Link href="/products" className="inline-flex items-center gap-2 mb-4">
            ...
            <span className="text-[17px] font-bold tracking-tight text-gray-900">আমার<span className="text-indigo-600">-শপ</span></span>          </Link>
          <h1 className="text-lg font-extrabold text-gray-900">Create account</h1>
          <p className="text-xs text-gray-400 mt-0.5">Start shopping in seconds</p>
        </div>
