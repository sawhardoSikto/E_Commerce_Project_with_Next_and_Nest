        ...
        <div className="text-center mb-5">
          ...
          {done ? (
            <>
              ...
              <h1 className="text-lg font-extrabold text-gray-900">Password reset!</h1>
              <p className="text-xs text-gray-400 mt-0.5">Redirecting you to login...</p>
            </>
          ) : (
            <>
              ...
              <h1 className="text-lg font-extrabold text-gray-900">Set new password</h1>
        ...
        {done ? (
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5 text-center">
            <div className="flex items-center justify-center gap-2 text-emerald-600 mb-3">
              ...
              <span className="text-sm font-semibold">Your password has been updated.</span>
            </div>
            <Link href="/login"
              className="block w-full py-2 text-xs font-semibold text-white bg-indigo-600 hover:bg-indigo-700 rounded-lg shadow-sm shadow-indigo-200 transition-colors text-center">
              Go to Sign in
            </Link>
          </div>
        ) : (
